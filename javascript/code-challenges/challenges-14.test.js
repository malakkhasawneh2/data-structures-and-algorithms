...
const screenForNames = (arr) => {
  ...
  return arr.filter(item => {
    return /^(Mr||Dr||Mrs||Ms).\s[A-Z]/.test(item);
  })
}
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const detectTicTacToeWin = (board) => {
  ...
  // return TicTacToe
  if (TicTacToe[0] == TicTacToe[1] && TicTacToe[0] == TicTacToe[2] && TicTacToe[0] != '') {
    return true;
  } else if (TicTacToe[3] == TicTacToe[4] && TicTacToe[3] == TicTacToe[5] && TicTacToe[3] != '') { return true; }
  else if (TicTacToe[6] == TicTacToe[7] && TicTacToe[6] == TicTacToe[8] && TicTacToe[6] != '') { return true; }
  else if (TicTacToe[0] == TicTacToe[3] && TicTacToe[0] == TicTacToe[6] && TicTacToe[0] != '') { return true; }
  else if (TicTacToe[1] == TicTacToe[4] && TicTacToe[1] == TicTacToe[7] && TicTacToe[1] != '') { return true; }
  else if (TicTacToe[2] == TicTacToe[5] && TicTacToe[2] == TicTacToe[8] && TicTacToe[2] != '') { return true; }
  else if (TicTacToe[0] == TicTacToe[4] && TicTacToe[0] == TicTacToe[8] && TicTacToe[0] != '') { return true; }
  else if (TicTacToe[2] == TicTacToe[4] && TicTacToe[2] == TicTacToe[6] && TicTacToe[2] != '') { return true; }
  else return false
};
