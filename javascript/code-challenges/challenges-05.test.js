...
const addValues = (arr) => {
  // Solution code here...
  let newArray = arr.reduce((input, element) => {
    input = input + element;
    return input;
  }, 0);
  return (newArray);
...
const addPurchases = (arr) => {
  // Solution code here...
  let total = arr.reduce((input, value) => {
    input = input + value.purchasePrice;
    return input;
  }, 0);
  return total;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let number = arr.reduce((input, value) => {
    input += 1;
    return input;
  }, 0);
  return number;
...
const returnNames = (arr) => {
  // Solution code here...
  let nameArr = arr.reduce((input, value) => {
...
const reversedString = (str) => {
  ...
  let newWord  = splitString.reduce((acc, item) => {
    return item + acc;
  }, "");
  return newWord ;
};
